...
quadArray::quadArray(unsigned int capacity){
...
int main(){
  ...
  for(i=0;i<=symbol_table->curr_length;i++){
  	if((symbol_table->table[i]).nestedTable){
  		printf("\n\n________________________________________ %s Symbol Table ________________________________________\n\n",(symbol_table->table[i]).name);
